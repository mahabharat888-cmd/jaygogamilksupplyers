...
import { Eye, EyeOff, Mail, Lock, User, Milk, MailCheck } from 'lucide-react';
...
const Register: React.FC<RegisterProps> = ({ onToggleMode }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { success, error: authError } = await register(trimmedEmail, trimmedUsername, formData.password);
